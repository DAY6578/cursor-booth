...
const THEME_IDS = ["neon", "minimal", "pastel", "mono"];
const THEME_ACCENTS = {
  neon: "#39f3ff",
  minimal: "#ff4d2e",
  pastel: "#ff8fbf",
...
window.addEventListener("message", function (event) {
  ...
  if (!data || data.type !== "ugoku-clock") return;
  state = normalize(
    {
      theme: data.theme,
      hours: data.hours,
